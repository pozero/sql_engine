...
//    }
    ...
    @PostMapping
    public String generateApi(@RequestBody UrlSqlInfo info) {
        System.out.println(info);
        urlSqlInfoService.insertOrUpdate(info.getUrl(), info.getMethod(), info.getUserSql(), info.getDbId());
        return "api接口已生成！";
    }
...
//    }
    ...
    @DeleteMapping
    public String deleteApi(@RequestBody UrlSqlInfo info) {
        urlSqlInfoService.deleteExisted(info.getUrl(), info.getMethod());
        return "api接口已删除！";
    }
